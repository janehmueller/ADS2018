...
class MultiNodeIncBpTestMultiJvmNode1 extends MultiNodeIncBpTest
class MultiNodeIncBpTestMultiJvmNode2 extends MultiNodeIncBpTest
class MultiNodeIncBpTestMultiJvmNode3 extends MultiNodeIncBpTest
class MultiNodeIncBpTestMultiJvmNode4 extends MultiNodeIncBpTest

class MultiNodeIncBpTest extends MultiNodeSpec(MultiNodeADSBpConfig) with STMultiNodeSpec with ImplicitSender {

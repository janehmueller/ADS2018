...
class MultiNodeIncFlatTestMultiJvmNode1 extends MultiNodeIncFlatTest
class MultiNodeIncFlatTestMultiJvmNode2 extends MultiNodeIncFlatTest
class MultiNodeIncFlatTestMultiJvmNode3 extends MultiNodeIncFlatTest
class MultiNodeIncFlatTestMultiJvmNode4 extends MultiNodeIncFlatTest

class MultiNodeIncFlatTest extends MultiNodeSpec(MultiNodeADSConfig) with STMultiNodeSpec with ImplicitSender {

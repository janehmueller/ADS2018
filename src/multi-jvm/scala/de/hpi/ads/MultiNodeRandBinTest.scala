...
class MultiNodeRandBinTestMultiJvmNode1 extends MultiNodeRandBinTest
class MultiNodeRandBinTestMultiJvmNode2 extends MultiNodeRandBinTest
class MultiNodeRandBinTestMultiJvmNode3 extends MultiNodeRandBinTest
class MultiNodeRandBinTestMultiJvmNode4 extends MultiNodeRandBinTest

class MultiNodeRandBinTest extends MultiNodeSpec(MultiNodeADSBinaryConfig) with STMultiNodeSpec with ImplicitSender {

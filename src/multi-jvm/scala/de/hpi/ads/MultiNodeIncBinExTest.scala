...
class MultiNodeIncBinExTestMultiJvmNode1 extends MultiNodeIncBinExTest
class MultiNodeIncBinExTestMultiJvmNode2 extends MultiNodeIncBinExTest
class MultiNodeIncBinExTestMultiJvmNode3 extends MultiNodeIncBinExTest
class MultiNodeIncBinExTestMultiJvmNode4 extends MultiNodeIncBinExTest

class MultiNodeIncBinExTest extends MultiNodeSpec(MultiNodeADSBinaryConfig) with STMultiNodeSpec with ImplicitSender {
    ...
    "MultiNode Table" should "insert and return values" in within(1000 seconds) {
        runOn(node1) {
            ...
            Thread.sleep(1000)
            tableActor ! TableExpectDenseInsertRange(1, 20000)
            Thread.sleep(1000)

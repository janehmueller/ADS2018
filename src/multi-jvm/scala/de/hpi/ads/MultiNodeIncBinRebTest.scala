...
class MultiNodeIncBinRebTestMultiJvmNode1 extends MultiNodeIncBinRebTest
class MultiNodeIncBinRebTestMultiJvmNode2 extends MultiNodeIncBinRebTest
class MultiNodeIncBinRebTestMultiJvmNode3 extends MultiNodeIncBinRebTest
class MultiNodeIncBinRebTestMultiJvmNode4 extends MultiNodeIncBinRebTest

class MultiNodeIncBinRebTest extends MultiNodeSpec(MultiNodeADSBinaryConfig) with STMultiNodeSpec with ImplicitSender {
